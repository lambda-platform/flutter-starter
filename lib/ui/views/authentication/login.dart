...
//    }
  ...
  doLogin() async {
    bool isAuth = await _agentController.doLogin(
        context, '/auth/login', login.text, password.text,
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            _agentController.hasBio.value == true
                                ? Container(
                                    alignment: Alignment.center,
                                    height: 28,
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Text(
                                          _agentController.bioType.value ==
                                                  'face'
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                IconButton(
                                    icon: Icon(
                                       Icons.fingerprint,
                                      color: _agentController
                                                  .isBioRemember.value &&
                                              _agentController.password.value !=
                                                  "" &&
                                              _agentController.password.value !=
                                                  null
                                          ? Color(0xFF0D47A1)
