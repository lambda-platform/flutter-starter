...
//   @override
//   _RepairHistoryDetailScreenState createState() =>
//       _RepairHistoryDetailScreenState();
// }

// class _RepairHistoryDetailScreenState extends State<RepairHistoryDetailScreen> {
//   var requestID = Get.arguments;
//   Future<dynamic> _getData() async {
//     final response = await client.execute(
//       RepairHistoryDetailQuery(
//         variables: RepairHistoryDetailArguments(
...
//                                     snapshot.data[0].endedAt ?? DateTime.now(),
//                                   ),
//                                   style: TextStyle(
//                                     fontSize: 14.0,
//                                     color: textDarkGrey,
