...
import 'package:ubengineering/ui/views/enrichment/enrichment.dart';
...
class EnricherLayout extends StatefulWidget {

  @override
  _EnricherLayoutState createState() => _EnricherLayoutState();
}

class _EnricherLayoutState extends State<EnricherLayout> {
  ...
  void initState() {
    _pages.addAll([
      ...
      // QR(),
      Container(),
      EnrichmentScreen(_openEndDrawer),
      Notifications(),
    ]);
    super.initState();
  }
