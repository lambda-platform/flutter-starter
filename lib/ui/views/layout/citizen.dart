...
class CititzenLayout extends StatefulWidget {
  const CititzenLayout({Key? key}) : super(key: key);

  @override
  _CititzenLayoutState createState() => _CititzenLayoutState();
}

class _CititzenLayoutState extends State<CititzenLayout> {
  ...
  void onItemTapped(int index) {
    if (index == 1) {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => UserRequest()));
    } else {
      setState(() {
        selectedIndex = index;
      });
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          appController.user.value.avatar != ""
                              ? CircleAvatar(
